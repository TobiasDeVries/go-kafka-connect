...
// AddRootCertificate provides a mock function with given fields: pemFilePath
func (_m *MockHighLevelClient) AddRootCertificate(pemFilePath string) {
	_m.Called(pemFilePath)
}
